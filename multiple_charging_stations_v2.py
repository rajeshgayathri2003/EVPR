...
if __name__ == "__main__":
    ...
    print(f"Grid purchase price: {grid_price}¢")
    ...
    lambda_max = np.random.randint(25, 30, size=(n, k))  # Max price users will accept
    lambda_b = np.random.randint(10, 15, size=(n, k))    # Price where users become sensitive
